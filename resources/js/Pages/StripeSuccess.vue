<template>
    <div class="bg-base-200 flex justify-center items-center lg:px-0 py-8">
        <div
            class="bg-white my-20 shadow-lg max-w-md md:w-[600px] p-4 rounded-xl"
        >
            <ion-icon
            ...
            <div class="bg-gray-100">
                <div
                    class="items-center flex gap-4 justify-between px-3 pt-2 mt-8 border-t"
                >
                ...
                <div class="items-center flex gap-4 justify-between px-3 mt-3">
                    <p class="text-sm text-gray-600">Name</p>
                    <p class="text-sm text-gray-600">{{ data.customer }}</p>
                </div>
                <div class="items-center flex gap-4 justify-between px-3 mt-3 pb-3">
